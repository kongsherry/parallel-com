...
public:
    ...
    int FindLetter(segment seg)const;
    int FindDigit(segment seg)const;
    int FindSymbol(segment seg)const;
...
public:
    ...
    vector<string> GenerateForPT(PT pt);
    void GenerateBatch(const vector<PT>& batch);
    void PopMultiple(int batch_size);
